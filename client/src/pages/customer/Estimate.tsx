                      ...
                      {isRelocation && hasDRMode && (
                        <div data-testid="notice-relocation-dr" className="mt-3 flex items-start gap-2 bg-green-50 border border-green-200 rounded px-3 py-2.5">
                          ...
                          <div className="text-xs text-green-800 leading-relaxed">
                            <span className="font-black">No hourly overtime.</span> Your dismantle &amp; reinstall labor is priced per item, not by the hour. Other charges in our Terms — second-day continuation, waiting time, and floor &amp; access surcharges — may still apply if site conditions differ from your booking.
                          </div>
                        </div>
                      )}
                      ...
                      {isRelocation && hasDRMode && (
                        <div data-testid="notice-relocation-dr-review" className="flex items-start gap-2 bg-green-50 border border-green-200 rounded px-3 py-2 mt-1">
                          ...
                          <p className="text-xs text-green-800 leading-relaxed">
                            <span className="font-black">No hourly overtime.</span> This job's dismantle &amp; reinstall labor is priced per item, not by the hour. Other charges in our Terms — second-day continuation, waiting time, and floor &amp; access surcharges — may still apply if site conditions differ from your booking.
                          </p>
                        </div>
                      )}
                      {isRelocation && !hasDRMode && items.some(i => i.serviceType === 'relocate') && (
