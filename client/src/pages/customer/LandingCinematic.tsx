...
/* ─────────────────────── Scene3D — In-page scroll-to-assemble ───────────────────────
   A full-bleed section the user scrolls THROUGH. The 3D workstation is pinned
   sticky inside the section while parts assemble in real perspective space,
   driven by the section's own scroll progress. This complements (does not
   replace) the small persistent <FloatingScene3D /> companion in the corner. */
...
function Scene3D() {
  ...
  const ghostY = useTransform(scrollYProgress, [0, 1], [40, -120]);
      ...
      <div className="sticky top-0 h-screen w-full overflow-hidden">
        ...
        <div className="absolute top-0 inset-x-0 z-[5] px-5 md:px-10 lg:px-14 pt-16 md:pt-20 pb-4 border-b" style={{ borderColor: LINE }}>
          <div className="grid grid-cols-12 gap-3 md:gap-8 items-end">
            ...
            <motion.div className="col-span-12 md:col-span-8" style={{ y: headlineY }}>
              <h2
        ...
        {/* Floating editorial fragments (parallax labels — Paradiso-flavored) */}
        ...
        <div className="hidden md:block absolute top-[46%] left-[3%] z-[6] text-[10px] tracking-[0.2em] uppercase font-bold pointer-events-none">
          <span style={{ background: INK, color: PAPER, padding: "2px 6px" }}>§ scroll ↓</span>
        </div>
        <div className="hidden md:block absolute top-[46%] right-[3%] z-[6] text-[10px] tracking-[0.2em] uppercase font-bold pointer-events-none">
          <span style={{ background: ACCENT, color: INK, padding: "2px 6px" }}>live</span>
        </div>
