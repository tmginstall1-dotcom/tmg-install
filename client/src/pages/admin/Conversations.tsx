...
const STATE_CONFIG: Record<string, { label: string; color: string; bg: string; dot: string }> = {
 ...
 awaiting_items: { label: "Listing items", color: "text-[#0A0A0A]", bg: "bg-[#EBE9E2] border-violet-200", dot: "bg-violet-500" },
 awaiting_items_verify: { label: "Verifying items", color: "text-[#0A0A0A]", bg: "bg-[#EBE9E2] border-violet-200", dot: "bg-violet-500" },
...
function Avatar({ name, phone, size = "md" }: { name: string | null; phone: string; size?: "sm" | "md" | "lg" }) {
 ...
 return (
 <div className={`rounded-full bg-gradient-to-br ${avatarGradient(phone)} ${sz[size]} flex items-center justify-center flex-shrink-0 font-bold text-white `}>
...
function ImageLightbox({ src, onClose }: { src: string; onClose: () => void }) {
 ...
 src={src}
 alt="Customer photo"
 className="max-w-full max-h-full rounded-none object-contain "
...
function MessageBubble({
 ...
 ? "bg-[#fffbd5] text-amber-900 border border-amber-200 "
 : isOut
 ? isAdm
 ...
 >
 {copied && (
 <span className={`absolute z-20 -top-7 text-[11px] font-semibold px-2.5 py-1 rounded-full bg-zinc-800 text-white flex items-center gap-1 pointer-events-none ${isOut ? "right-0" : "left-0"}`}>
 ...
 src={imgSrc}
 alt="Photo"
 className="rounded-none max-w-full max-h-64 object-cover w-full block"
 onError={e => {
 ...
 <div className="absolute inset-0 bg-black/0 group-hover:bg-black/20 rounded-none transition-all flex items-center justify-center">
 <ZoomIn className="w-6 h-6 text-white opacity-0 group-hover:opacity-100 transition-all drop-" />
 </div>
 </div>
 ...
 <div className={`flex items-center gap-2 px-3 py-1.5 ${radius} bg-white/80 border border-black/8 `}>
...
function ChatPanel({
 ...
 {selectedConvo?.state && (
 <div className={`rounded-none px-3 py-3 mb-3 border ${getState(selectedConvo.state).bg}`}>
 ...
 className="w-8 h-8 flex items-center justify-center rounded-full bg-amber-500 text-white hover:bg-amber-400 transition-all disabled:opacity-60 sm:w-auto sm:h-auto sm:px-2.5 sm:py-1.5 sm:rounded-none sm:gap-1.5 sm:text-xs sm:font-semibold"
 title="Resume bot"
 >
 ...
 className="w-8 h-8 flex items-center justify-center rounded-full text-white/70 hover:bg-white/10 hover:text-white transition-all disabled:opacity-60 sm:w-auto sm:h-auto sm:px-2.5 sm:py-1.5 sm:rounded-none sm:gap-1.5 sm:text-xs sm:font-semibold"
 ...
 className="w-8 h-8 flex items-center justify-center rounded-full bg-[#25D366] text-white hover:bg-[#1db954] transition-all disabled:opacity-60 sm:w-auto sm:h-auto sm:px-2.5 sm:py-1.5 sm:rounded-none sm:gap-1.5 sm:text-xs sm:font-semibold"
 ...
 className={`hidden lg:flex px-2.5 py-1.5 rounded-none text-xs font-semibold transition-all ${
 ...
 <div className="flex-1 flex items-center gap-2 rounded-none px-3 py-2" style={{ background: "#2a3942" }}>
 ...
 <div className="lg:hidden flex-shrink-0 border-b border-gray-200 bg-white animate-in slide-in-from-top-2 duration-200 z-10">
 ...
 className="flex-1 flex items-center justify-center gap-1.5 py-2 text-xs font-semibold rounded-lg bg-blue-50 border border-blue-200 text-[#0A0A0A] hover:bg-blue-100 transition-all disabled:opacity-60"
 >
 ...
 className="absolute bottom-3 left-1/2 -translate-x-1/2 z-20 flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[#25D366] text-white text-xs font-semibold animate-bounce"
 >
 ...
 <div className={`rounded-none bg-gray-200 ${r ? "w-52 h-12" : "w-60 h-14"}`} />
 </div>
 ))}
 </div>
 )}
 ...
 <span className="text-[11px] font-semibold px-3 py-1 rounded-full bg-white/80 border border-violet-200 text-[#0A0A0A] ">
 ...
 <span className="text-[11px] text-gray-400 font-medium px-3 py-1 rounded-full bg-white border border-gray-200 ">
 {group.date}
 </span>
 <div className="flex-1 h-px bg-gray-200" />
 </div>
 ...
 <FileText className="w-4 h-4 text-[#0A0A0A] flex-shrink-0" />
 <span className="text-xs text-[#0A0A0A] flex-1 min-w-0 truncate sm:whitespace-normal sm:truncate-none">
 ...
 className="flex items-center gap-1.5 px-3 py-1.5 rounded-none text-xs font-semibold bg-[#0A0A0A] text-white hover:bg-black transition-all disabled:opacity-60 flex-shrink-0 whitespace-nowrap"
 >
 ...
 className="w-full text-left px-3 py-2 rounded-none hover:bg-gray-50 transition-all border border-transparent hover:border-gray-200"
 >
 ...
 <div className="w-20 h-20 rounded-none border border-gray-200 bg-blue-50 flex flex-col items-center justify-center gap-1">
 ...
 {showEmojiPicker && (
 <div ref={emojiPickerRef} className="absolute bottom-full left-3 z-50 mb-1 rounded-none overflow-hidden border border-gray-200">
 <EmojiPicker
 theme={Theme.LIGHT}
 ...
 {windowClosed && (
 <div className="mx-2 mb-1.5 px-3 py-2.5 bg-amber-50 border border-amber-200 rounded-none">
 ...
 className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-[#0A0A0A] text-white text-[11px] font-semibold rounded-lg hover:bg-black active:scale-[0.98] transition-all"
 >
 ...
 className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-[#0A0A0A] text-white text-[11px] font-semibold rounded-lg hover:bg-violet-700 active:scale-[0.98] transition-all"
 >
 ...
 className={`resize-none overflow-hidden text-[15px] text-gray-900 placeholder:text-gray-400 min-h-[40px] py-2 px-3 rounded-none border transition-colors leading-relaxed focus-visible:ring-0 ${
 noteMode
 ...
 className={`w-8 h-8 rounded-full flex items-center justify-center transition-all ${
 showTemplates || showQuickReplies ? "text-[#0A0A0A] bg-[#EBE9E2]" : "text-gray-400 hover:text-[#0A0A0A] hover:bg-gray-100"
 }`}
 ...
 className={`w-9 h-9 rounded-full text-white flex-shrink-0 p-0 flex items-center justify-center disabled:opacity-40 transition-all ml-0.5 ${
 ...
 <button
 className="w-9 h-9 rounded-full bg-[#25D366] text-white flex-shrink-0 flex items-center justify-center ml-0.5"
...
export default function AdminConversations() {
 ...
 return (
 <div
 className="flex bg-[#F5F4F0] overflow-hidden lg:pl-56"
 ...
 {/* ═══ New Chat Dialog ════════════════════════════════════════════════ */}
 {showNewChat && (
 <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 bg-black/50 " onClick={() => setShowNewChat(false)}>
 <div className="bg-white rounded-none w-full max-w-md p-6" onClick={e => e.stopPropagation()}>
 ...
 className="w-full h-10 px-3 text-sm border border-gray-200 rounded-none focus:outline-none focus:border-blue-400 bg-gray-50 placeholder:text-gray-400"
 ...
 rows={3}
 className="w-full px-3 py-2.5 text-sm border border-gray-200 rounded-none focus:outline-none focus:border-blue-400 bg-gray-50 placeholder:text-gray-400 resize-none"
 data-testid="new-chat-message"
 />
 </div>
 <div className="flex gap-2 pt-1">
 <button onClick={() => setShowNewChat(false)} className="flex-1 py-2.5 text-sm font-semibold rounded-none border border-gray-200 text-gray-500 hover:bg-gray-50 transition-all">
 Cancel
 </button>
 <button
 onClick={() => {
 ...
 className="flex-1 py-2.5 text-sm font-semibold rounded-none bg-[#25D366] text-white hover:bg-[#1db954] disabled:opacity-50 transition-all flex items-center justify-center gap-2"
 >
 ...
 <div className={`w-14 h-14 rounded-none flex items-center justify-center ${filter === "escalation" ? "bg-red-50" : "bg-zinc-100"}`}>
 {filter === "escalation"
 ...
 <span className="text-[10px] font-semibold px-1.5 py-0.5 rounded-md text-[#0A0A0A] bg-blue-50 border border-blue-200 flex items-center gap-1">
 ...
 <div className="hidden lg:flex flex-1 items-center justify-center flex-col gap-4 bg-[#F5F4F0]">
 <div className="w-16 h-16 rounded-none bg-white border border-zinc-200 flex items-center justify-center">
 ...
 <button
 onClick={() => setShowNewChat(true)}
 className="flex items-center gap-1.5 px-4 py-2 rounded-none bg-[#25D366] text-white text-sm font-semibold hover:bg-[#1db954] transition-all "
