...
function ScheduleEditor({
 ...
 className="text-xs font-medium text-[#0A0A0A] hover:text-[#0A0A0A] hover:underline whitespace-nowrap mt-0.5"
 >
 Edit
 </button>
 </div>
 ...
 className="h-10 w-full px-3 border border-zinc-300 rounded-lg text-sm bg-white text-zinc-900 text-left focus:outline-none focus:ring-2 focus:ring-[#0A0A0A]"
 />
 {(() => {
 ...
 className="h-10 w-full px-3 border border-zinc-300 rounded-lg text-sm bg-white text-zinc-900 focus:outline-none focus:ring-2 focus:ring-[#0A0A0A]"
 >
 {TIME_WINDOWS.map(tw => (
 ...
 className="h-10 px-4 rounded-lg bg-[#0A0A0A] hover:bg-black text-white text-sm font-medium disabled:opacity-50 transition-colors"
 >
...
function PaymentChannelButtons({
 ...
 ? "inline-flex items-center justify-center gap-1.5 h-10 px-3 rounded-none text-sm font-medium transition-colors disabled:opacity-50"
 ...
 <button
 onClick={onCopy}
 className={`${baseBtn} w-full bg-[#EBE9E2] hover:bg-violet-100 text-[#0A0A0A] border border-violet-200`}
...
export default function AdminQuoteDetail() {
 ...
 if (isLoading) {
 return (
 <div className="min-h-screen pt-14 pb-16 lg:pl-56 bg-[#F5F4F0] flex items-center justify-center">
...
<body>
 ...
 return (
 <div className="min-h-screen pt-14 pb-32 lg:pb-16 lg:pl-56 bg-[#F5F4F0] overflow-x-hidden relative">
 ...
 rows={3}
 className="w-full p-3 border border-zinc-300 rounded-lg text-sm bg-white text-zinc-900 focus:outline-none focus:ring-2 focus:ring-[#0A0A0A] focus:border-[#0A0A0A] transition-colors resize-none"
 ...
 <span className="text-[10.5px] text-[#0A0A0A]/80 ml-auto">Next invoice for this customer will start with these details pre-filled.</span>
 </div>
 ...
 <a href={`mailto:${quote.customer?.email}`} className="text-sm text-[#0A0A0A] hover:underline">{quote.customer?.email}</a>
 </div>
 <div className="grid grid-cols-[100px_1fr] gap-2 items-center">
 ...
 {twLabel && (
 <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-semibold w-fit bg-blue-50 text-[#0A0A0A] border border-blue-200">
 ...
 className="group relative aspect-square rounded-lg overflow-hidden border border-zinc-200 focus:outline-none focus:ring-2 focus:ring-[#0A0A0A]"
 >
 ...
 className="inline-flex items-center gap-2 h-7 px-2.5 rounded-md text-[#0A0A0A] hover:bg-blue-50 text-xs font-medium transition-colors">
 ...
 maxLength={500}
 className="mt-1.5 h-9 w-full sm:w-72 px-3 border border-zinc-300 rounded-lg text-sm bg-white text-zinc-900 focus:outline-none focus:ring-2 focus:ring-[#0A0A0A] focus:border-[#0A0A0A] transition-colors" />
 </div>
 </div>
 
 <div className="text-right w-full sm:w-auto bg-zinc-50 p-4 rounded-none border border-zinc-200">
 ...
 className="flex items-center gap-1.5 text-xs font-medium text-[#0A0A0A] hover:text-[#0A0A0A] transition-colors"
 >
 ...
 className="w-full text-sm border border-zinc-300 rounded-lg px-3 py-2 bg-white focus:outline-none focus:ring-2 focus:ring-[#0A0A0A]"
 >
 ...
 className="flex-1 bg-[#0A0A0A] hover:bg-black disabled:opacity-50 text-white text-sm font-medium py-2 rounded-lg transition-colors"
 >
 ...
 step.done ? 'bg-[#0A0A0A] text-white' : 
 step.active ? 'bg-white border-2 border-blue-600 text-[#0A0A0A]' : 
 'bg-zinc-100 border border-zinc-300 text-transparent'
 }`}>
 {step.done && <CheckCircle2 className="w-3.5 h-3.5" />}
 {!step.done && step.active && <div className="w-2 h-2 rounded-full bg-[#0A0A0A]" />}
 </div>
 ...
 className="inline-flex items-center justify-center w-full gap-2 h-9 px-4 rounded-lg bg-[#0A0A0A] hover:bg-black text-white text-sm font-medium transition-colors disabled:opacity-50">
 ...
 className="h-10 w-full px-3 border border-zinc-300 rounded-lg text-sm bg-white text-zinc-900 focus:outline-none focus:ring-2 focus:ring-[#0A0A0A] focus:border-[#0A0A0A] transition-colors">
 ...
 <div className="w-8 h-8 rounded-full bg-blue-200 flex items-center justify-center text-[#0A0A0A] font-bold">{quote.assignedStaff.name[0]}</div>
 <div>
 <p className="text-sm font-semibold text-blue-900">{quote.assignedStaff.name}</p>
 <p className="text-xs text-[#0A0A0A]">Staff Assigned</p>
 </div>
 </div>
 )}
 ...
 className="inline-flex items-center justify-center w-full gap-2 h-9 px-4 rounded-lg bg-[#0A0A0A] hover:bg-black text-white text-sm font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
 >
 <CheckCircle2 className="w-4 h-4" />
 ...
 className="inline-flex items-center justify-center w-full gap-2 h-10 px-4 rounded-lg bg-[#0A0A0A] hover:bg-black text-white text-sm font-medium transition-colors disabled:opacity-50">
 ...
 className="inline-flex items-center justify-center w-full gap-2 h-10 px-4 rounded-lg bg-[#0A0A0A] hover:bg-black text-white text-sm font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
 >
 <DollarSign className="w-4 h-4" />
 {finalPaymentBlockedByPhases
 ? `Waiting on ${applicablePhases.filter(p => !phaseStatus(p.key)).map(p => p.label).join(" + ")}`
 ...
 className="flex-1 h-9 px-3 text-sm border border-zinc-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0A0A0A]"
 />
 ...
 className="w-full h-9 px-3 text-sm border border-zinc-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0A0A0A]"
 />
 </div>
 <div className="space-y-1">
 ...
 className="w-full inline-flex items-center justify-center gap-2 h-11 rounded-none bg-[#0A0A0A] hover:bg-black text-white text-sm font-semibold transition-colors disabled:opacity-50">
 <CalendarCheck className="w-4 h-4" />
 ...
 className="w-full inline-flex items-center justify-center gap-2 h-9 rounded-none bg-white border border-emerald-300 text-emerald-700 text-xs font-semibold transition-colors">
 ...
 disabled={requestFinalPayment.isPending || finalPaymentBlockedByPhases}
 title={finalPaymentBlockedByPhases ? "Tick all job phases before requesting final payment" : undefined}
 className="w-full inline-flex items-center justify-center gap-2 h-11 rounded-none bg-[#0A0A0A] hover:bg-black text-white text-sm font-semibold transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
 >
 <CheckCircle2 className="w-4 h-4" />
 {finalPaymentBlockedByPhases
 ? `Waiting on ${applicablePhases.filter(p => !phaseStatus(p.key)).map(p => p.label).join(" + ")}`
 ...
 className="flex-1 inline-flex items-center justify-center gap-1.5 h-10 px-3 rounded-none bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-semibold transition-colors">
