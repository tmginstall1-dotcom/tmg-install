...
export default function GGVJobs() {
 ...
 <div className="w-9 h-9 rounded-none bg-emerald-500/15 flex items-center justify-center">
 ...
 variant="outline"
 className="border-[#0A0A0A]/40 text-blue-400 hover:bg-blue-500/10 hover:text-blue-300 font-bold text-xs gap-1.5"
 >
 {scanning ? (
 ...
 {scanning && (
 <div className="mb-4 flex items-center gap-3 bg-blue-500/10 border border-[#0A0A0A]/25 rounded-none px-4 py-3">
 ...
 <div className="rounded-none border border-white/8 bg-slate-900 p-8 flex flex-col items-center gap-3 text-slate-600">
 ...
 <button
 onClick={() => fileInputRef.current?.click()}
 className="flex items-center gap-1.5 text-xs text-blue-400 font-semibold border border-[#0A0A0A]/30 px-3 py-1.5 rounded-lg"
 >
 ...
 isSelected
 ? "bg-blue-500/10 border-[#0A0A0A]/40"
 : isFlagged
 ...
 <div key={label} className="bg-slate-900 border border-white/8 rounded-none p-3 text-center">
 ...
 {/* ── Desktop table (≥ md) ─────────────────────────────────────────────── */}
 <div className="hidden md:block rounded-none border border-white/8 overflow-hidden bg-slate-900">
 ...
 <button
 onClick={() => fileInputRef.current?.click()}
 className="mt-1 flex items-center gap-1.5 text-xs text-blue-400 hover:text-blue-300 font-semibold border border-[#0A0A0A]/30 px-3 py-1.5 rounded-lg hover:bg-blue-500/10 transition-colors"
 >
 <Upload className="w-3 h-3" /> Upload & Scan
 </button>
 </div>
 ...
 <div key={label} className="bg-slate-900 border border-white/8 rounded-none p-4 text-center">
