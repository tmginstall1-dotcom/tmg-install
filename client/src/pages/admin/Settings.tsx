...
export default function AdminSettings() {
 ...
 <p className="text-sm text-black/55 mt-1">Configure integrations and app behavior</p>
 </div>
 </div>
 ...
 <Label htmlFor="wa-token" className="text-xs text-black/55">New Access Token</Label>
 <Textarea
 id="wa-token"
 ...
 rows={4}
 className="font-mono text-xs w-full p-3 border border-black/20 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0A0A0A] focus:border-[#0A0A0A] transition-colors"
 />
 </div>
 ...
 className="inline-flex items-center justify-center gap-2 h-9 px-4 rounded-lg bg-white border border-black/20 text-black/70 hover:bg-white text-sm font-medium transition-colors w-full disabled:opacity-50"
 >
 ...
 disabled={requestCode.isPending}
 className="inline-flex items-center justify-center gap-2 h-9 px-4 rounded-lg bg-white border border-black/12 text-black/65 hover:bg-white text-sm font-medium transition-colors w-full disabled:opacity-50"
 >
 {requestCode.isPending
 ...
 <Label htmlFor="otp-code" className="text-xs text-black/55">Enter the 6-digit code from the SMS / voice call</Label>
 ...
 className="inline-flex items-center justify-center gap-2 h-9 px-4 rounded-lg bg-[#0A0A0A] hover:bg-black text-white text-sm font-medium transition-colors disabled:opacity-50 shrink-0"
 >
 ...
 <Label htmlFor="direct-pin" className="text-xs text-black/55">Choose a 6-digit PIN (you'll need this for 2FA)</Label>
 <div className="flex gap-2">
 <Input
 id="direct-pin"
 ...
 <p className="text-xs text-black/55">Write down this PIN — Meta may ask for it later for account verification.</p>
 </div>
 </div>
 </div>
 ...
 <div className="bg-white border border-black/12 rounded-lg p-4">
 <div className="flex items-center justify-between mb-2">
 <div className="flex items-center gap-2">
 <div className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse" />
 <span className="text-sm font-semibold text-[#0A0A0A]">Live on all staff phones</span>
 </div>
 <span className="text-xl font-bold text-[#0A0A0A]" data-testid="text-current-version">
 ...
 target="_blank"
 rel="noreferrer"
 className="inline-flex items-center gap-1.5 text-xs font-medium text-[#0A0A0A] hover:text-[#0A0A0A] hover:underline break-all"
 >
 ...
 {/* How it works */}
 <div className="flex items-start gap-3 bg-white border border-black/12 rounded-lg p-3.5">
 <GitBranch className="w-4 h-4 text-black/45 shrink-0 mt-0.5" />
 <div className="text-xs text-black/65 leading-relaxed">
 <strong className="text-[#0A0A0A] font-semibold">How auto-update works:</strong><br />
 ...
 className="w-full flex items-center justify-between text-xs font-semibold text-black/55 hover:text-black/70 py-1 transition-colors"
 >
 ...
 <p className="text-sm text-black/55">No promo codes found.</p>
 ) : (
 promoCodes.map(p => (
 <div key={p.id} className="border border-black/12 rounded-lg p-4 space-y-3">
 <div className="flex items-center justify-between gap-3">
 <div>
 <div className="flex items-center gap-2">
 <span className="font-mono font-bold text-sm tracking-widest text-[#0A0A0A]">{p.code}</span>
 <span className={`inline-flex items-center rounded-md px-2 py-0.5 text-[11px] font-semibold ${p.active ? "bg-emerald-100 text-emerald-700" : "bg-[#EBE9E2] text-black/55"}`}>
 ...
 className="inline-flex items-center justify-center w-8 h-8 rounded-lg bg-white border border-black/12 text-black/65 hover:bg-white transition-colors disabled:opacity-50"
 >
 ...
 p.active 
 ? "bg-[#EBE9E2] text-black/70 hover:bg-[#EBE9E2]" 
 : "bg-white border border-black/12 text-black/70 hover:bg-white"
 }`}
 >
 {p.active ? (
 ...
 className="inline-flex items-center justify-center h-8 px-3 rounded-lg bg-white border border-black/12 text-black/70 hover:bg-white text-xs font-medium transition-colors"
 >
 Edit
 </button>
 </div>
 ...
 {/* Progress bar */}
 <div className="space-y-1">
 <div className="flex justify-between text-[11px] font-medium text-black/55">
 <span>Slots used</span>
 <span>{p.usesCount} / {p.maxUses}</span>
 </div>
 <div className="w-full bg-[#EBE9E2] rounded-full h-1.5 overflow-hidden">
 <div
 ...
 className="inline-flex items-center justify-center gap-2 h-9 px-4 rounded-lg bg-white border border-black/12 text-black/70 hover:bg-white text-sm font-medium transition-colors"
 ...
 <p className="text-xs text-black/55 mt-1">The WhatsApp bot answers "What time are you open?" from these settings.</p>
 </div>
 </div>
 ...
 : <ToggleLeft className="w-4 h-4 text-black/45" />}
 <span className={day.open ? "text-[#0A0A0A] font-medium" : "text-black/45"}>{label}</span>
 </button>
 {day.open ? (
 <div className="flex items-center gap-2">
 <Input
 ...
 className="h-8 w-32 text-sm border-black/20"
 />
 <span className="text-xs text-black/45">to</span>
 <Input
 type="time"
 value={day.end}
 ...
 <span className="text-xs text-black/45 italic">Closed</span>
 )}
 </div>
 );
 })}
 ...
 <p className="text-xs text-black/55 mt-1">These values are read by the WhatsApp bot to answer customer questions accurately.</p>
 </div>
 <div className="p-5 space-y-4">
 <div>
 ...
 className="h-9 text-sm border-black/20 w-20"
 />
 ...
 <div>
 <Label className="text-xs text-black/55 uppercase tracking-wide font-semibold mb-1.5 flex items-center gap-1.5">
 ...
 <p className="text-xs text-black/55 mt-1">Send a WhatsApp reminder to customers the day before their scheduled appointment.</p>
 </div>
 <div className="p-5 flex items-center justify-between">
 <div>
 <p className="text-sm font-medium text-[#0A0A0A]">Day-before WhatsApp reminder</p>
 <p className="text-xs text-black/55 mt-0.5">Sent automatically between 9 AM – 6 PM, once per job.</p>
 </div>
 <button
 ...
 : <ToggleLeft className="w-6 h-6 text-black/45" />}
 <span className={waRemindersEnabled ? "text-[#0A0A0A]" : "text-black/55"}>
 ...
 <p className="text-xs text-black/55 mt-1">Automatically apply a 5% discount for customers who have had a previous completed job.</p>
 </div>
 <div className="p-5 flex items-center justify-between">
 <div>
 <p className="text-sm font-medium text-[#0A0A0A]">5% loyalty discount for returning customers</p>
 <p className="text-xs text-black/55 mt-0.5">Applied at quote submission if the customer's phone number has a prior completed job.</p>
 </div>
 <button
 ...
 : <ToggleLeft className="w-6 h-6 text-black/45" />}
 <span className={loyaltyEnabled ? "text-amber-700" : "text-black/55"}>
 ...
 <div className="px-5 py-4 border-b border-black/8">
 <h2 className="text-sm font-semibold text-[#0A0A0A] flex items-center gap-2">
 <BellRing className="h-4 w-4 text-[#0A0A0A]" />
 ...
 <div className="flex items-start gap-2 bg-white border border-black/12 rounded-lg p-3 text-sm text-black/65">
 <AlertCircle className="w-4 h-4 shrink-0 mt-0.5 text-black/45" />
 ...
 className="inline-flex items-center gap-1.5 h-9 px-3 rounded-lg bg-[#EBE9E2] text-black/70 hover:bg-[#EBE9E2] text-sm font-medium transition-colors shrink-0"
 >
 ...
 className="inline-flex items-center gap-1.5 h-9 px-3 rounded-lg bg-[#0A0A0A] hover:bg-black text-white text-sm font-medium transition-colors shrink-0"
 >
 ...
 <div className="flex items-start gap-2 bg-[#EBE9E2] border border-blue-100 rounded-lg p-3 text-xs text-blue-800">
