    ...
    <>
      ...
      <Suspense fallback={<PageLoader />}>
        <Switch>
          ...
          <Route path="/invoice/:refNo" component={Invoice} />
          ...
          <Route path="/admin/receipts">
            {() => <AdminRoute component={AdminReceipts} />}
          </Route>
          ...
          <Route path="/admin/subcontractors">
            {() => <AdminRoute component={AdminSubcontractors} />}
          </Route>
          <Route path="/admin/ai">
          ...
          <Route path="/admin/ai/whatsapp">
            {() => <AdminRoute component={AdminAIWhatsApp} />}
          </Route>
