...
- All staff additionally get actual hourly + overtime pay derived from real clock-in/out attendance logs within range.
...
- P&L salary intentionally excludes meal allowance, transport allowance, unpaid-leave deductions, and loan repayments that the full payslip applies. Only basic + hourly + OT are included.
